...
public record FundoRequest(
    ...
    @Pattern(regexp = "^\\d{14}$", message = "CNPJ deve conter exatamente 14 dígitos (sem máscara)")
    @Schema(description = "CNPJ do fundo (14 dígitos, sem máscara)", example = "11728688000147")
    String cnpj,

...
import com.renlip.fiis.domain.enums.TipoProvento;
...
public record ProventoResponse(
    ...
    /**
     * Converte uma entidade {@link Provento} em {@link ProventoResponse}.
     *
     * @param provento entidade a converter
     * @return DTO populado
     */
    public static ProventoResponse of(Provento provento) {
        return new ProventoResponse(
            provento.getId(),
            FundoResumoResponse.of(provento.getFundo()),
            provento.getTipoProvento(),
            provento.getTipoProvento() != null ? provento.getTipoProvento().getDescricao() : null,
            provento.getDataReferencia(),
            provento.getDataPagamento(),
            provento.getValorPorCota(),
            provento.getQuantidadeCotas(),
            provento.calcularValorTotal(),
            provento.getObservacao(),
            provento.getDataCriacao(),
            provento.getDataAtualizacao()
        );
    }
}

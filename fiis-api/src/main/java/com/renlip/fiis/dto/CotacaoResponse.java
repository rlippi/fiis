...
public record CotacaoResponse(
    ...
    /**
     * Converte uma entidade {@link Cotacao} em {@link CotacaoResponse}.
     *
     * @param cotacao entidade a converter
     * @return DTO populado
     */
    public static CotacaoResponse of(Cotacao cotacao) {
        return new CotacaoResponse(
            cotacao.getId(),
            FundoResumoResponse.of(cotacao.getFundo()),
            cotacao.getData(),

...
INSERT INTO fundo (
    ...
    ('VISC11', 'Vinci Shopping FII', '17554274000125', 'TIJOLO', 'SHOPPING',   TRUE, '2026-01-03 10:00:00', '2026-01-03 10:00:00');

INSERT INTO cotacao (
    fundo_id, data, preco_fechamento, preco_abertura, preco_minimo, preco_maximo, volume, data_criacao, data_atualizacao
) VALUES
    (1, '2026-04-16', 158.0000, 157.5000, 157.0000, 158.5000, 1500000.00, '2026-04-16 18:00:00', '2026-04-16 18:00:00'),
    (1, '2026-04-17', 158.5000, 158.0000, 156.8000, 159.2000, 2450000.00, '2026-04-17 18:00:00', '2026-04-17 18:00:00'),
    (2, '2026-04-17',  10.2500,   NULL,     NULL,     NULL,        NULL,  '2026-04-17 18:00:00', '2026-04-17 18:00:00');
